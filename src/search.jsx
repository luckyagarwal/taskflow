...
export function SearchOverlay({ onClose }) {
  ...
  return (
    <div className="scrim" style={{ position: 'absolute', display: 'flex', alignItems: 'flex-start', justifyContent: 'center', paddingTop: '8%', zIndex: 200 }} onMouseDown={onClose}>
      <div onMouseDown={(e) => e.stopPropagation()} style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 11, padding: '14px 18px', borderBottom: '1px solid var(--border)' }}>
          ...
          <input ref={inputRef} value={q} onChange={(e) => setQ(e.target.value)} placeholder="Search tasks, projects, or jump to a view…"
              ...
              {matchTasks.map((t) => {
                ...
                return (
                  <Row key={t.id} onClick={() => open(t)}>
                    ...
                    {t.dueOffset !== null && <DueBadge offset={t.dueOffset} small />}
